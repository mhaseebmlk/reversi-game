...
socketio.on('setClientID', newID => {
    clientID = newID
    console.log('The new client id is: ' + clientID)
})
socketio.on('getCiD', () => {
    socketio.emit('cID', clientID)
})
...
$(() => {
    console.log('This clients id is: ' + clientID)

    socketio.on('connect', () => {
        console.log('--- CONNECTED TO THE SERVER --- ')
        socketio.emit('clientID', clientID)
    })
